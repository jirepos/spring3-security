package com.kyoofus.framework.security.basicauth.service;
...
/**
 * 스프링 시큐리티에서 Basic Authentication 사용 시 사용자 정보조회 서비스이다.
 */
// UserDetailsService를 구현해야 한다. 
@Service
@RequiredArgsConstructor
public class CustomBasicAuthUserDetailService implements UserDetailsService  {
