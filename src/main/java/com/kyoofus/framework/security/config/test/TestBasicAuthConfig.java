package com.kyoofus.framework.security.config.test;
...
import com.kyoofus.framework.security.basicauth.auth.CustomBasicAuthenticationEntryPoint;
...
public class TestBasicAuthConfig {
    private final CustomBasicAuthenticationEntryPoint myAuthenticationEntryPoint;
